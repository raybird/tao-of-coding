...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 創意發想、需求澄清、方案比較 | Oracle | `skills/tao-of-opencode/references/oracle.md` | Designer | `brainstorming` | `skills/tao-of-opencode/references/superpowers/brainstorming/SKILL.md` |
| 多步驟實作計畫撰寫 | Oracle | `skills/tao-of-opencode/references/oracle.md` | Librarian | `writing-plans` | `skills/tao-of-opencode/references/superpowers/writing-plans/SKILL.md` |
| 依既有計畫批次執行 | Explorer | `skills/tao-of-opencode/references/explorer.md` | Fixer | `executing-plans` | `skills/tao-of-opencode/references/superpowers/executing-plans/SKILL.md` |
| 新功能/修 Bug 的測試先行實作 | Fixer | `skills/tao-of-opencode/references/fixer.md` | Oracle | `test-driven-development` | `skills/tao-of-opencode/references/superpowers/test-driven-development/SKILL.md` |
| 錯誤追因、根因定位 | Fixer | `skills/tao-of-opencode/references/fixer.md` | Explorer | `systematic-debugging` | `skills/tao-of-opencode/references/superpowers/systematic-debugging/SKILL.md` |
| 宣告完成前驗證 | Fixer | `skills/tao-of-opencode/references/fixer.md` | Oracle | `verification-before-completion` | `skills/tao-of-opencode/references/superpowers/verification-before-completion/SKILL.md` |
| 發 PR/任務後請求審查 | Librarian | `skills/tao-of-opencode/references/librarian.md` | Oracle | `requesting-code-review` | `skills/tao-of-opencode/references/superpowers/requesting-code-review/SKILL.md` |
| 接收審查意見、分級處理 | Fixer | `skills/tao-of-opencode/references/fixer.md` | Librarian | `receiving-code-review` | `skills/tao-of-opencode/references/superpowers/receiving-code-review/SKILL.md` |
